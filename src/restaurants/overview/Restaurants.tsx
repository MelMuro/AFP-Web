...
const Restaurants = () => {
	return (
		<section className='relative bg-cover bg-ink bg-bottom h-full'>
			<div className='flex items-center'>
				<div className='w-1/2 px-14 py-44'>
					<h1 className='text-white'>De Asia a tu mesa</h1>
					<p className='text-white w-1/2'>
						Desde sabores picantes hasta dulces, bienvenido a Asia
						Yá, conoce nuestra variedad de restaurantes donde podrás
						descubrir nuevos sabores o disfrutar de tus favoritos
						llevados a otro nivel.
					</p>
					<img
						src={Nube1}
						alt=''
