...
import ink from '../assets/Tinta 5.png';
				...
				<div className='flex flex-row'>
					<div className='basis-1/2'>
						<form className='mr-12'>
							...
							>
								...
								<option value='hi' className='text-[#6D6D6D]'>
									Saludar
								</option>
							</select>
							<br />
							<label htmlFor='name' className='text-[#DD9E55]'>
								Ingresa tu nombre
							</label>
							<br />
							<input
							...
							/>
							<br />
							<label htmlFor='client' className='text-[#DD9E55]'>
					...
					<div className='basis-auto'>
						...
						<p className='text-white text-md'>
							¿Buscas llevar tu emprendimiento hacia un espacio
							único? Comunicate con nosotros por medio de nuestras
							redes sociales, teléfono o enviandonos un correo.
						</p>
						<p className='mt-5 text-white text-md'>
							Estamos abiertos a resolver dudas y brindar el mejor
							de los servicios.
						</p>
				...
				<div className='flex flex-row'>
					<div className='basis-1/2'>
						...
						<p className='text-white'>
							Av Cultura 55 Ote, Proyecto Rio Sonora Hermosillo
							XXI, 83280 Hermosillo, Son.
						</p>
					</div>
					<div className='basis-1/4'>
						<ul className='text-white'>
							<li className='font-semibold'>Asia-Ya Food Park</li>
